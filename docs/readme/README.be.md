...
- Пратэставана з Paper API `1.21.9` (гл. `<paper.version>` у `pom.xml`). Іншыя зборкі 1.21.x і форкі на базе Paper (напрыклад, Purpur 1.21.9) хутчэй за ўсё будуць працаваць, але выкарыстоўвайце іх на свой страх і рызыку.
- Патрабуецца Java 21 для зборкі і запуску.
